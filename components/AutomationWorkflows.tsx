...
const workflows = [
  {
    ...
    description: 'Recolha automatica de informacao de multiplas fontes e sistemas.',
    icon: (
  ...
  },
  {
    ...
    description: 'Analise e transformacao dos dados com algoritmos de IA avancados.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Acoes desencadeadas automaticamente com base em regras e condicoes definidas.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
